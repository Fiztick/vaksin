...
import com.pnj.vaksin.databinding.ActivityHafizEditPendaftaranBinding
import kotlinx.coroutines.launch
import java.io.File
import java.io.FileOutputStream
import java.io.OutputStream

class Hafiz_EditPendaftaranActivity : AppCompatActivity() {
    private var _binding: ActivityHafizEditPendaftaranBinding? = null
    ...
    lateinit var pendaftarDB: Hafiz_VaksinDatabase
    ...
    private fun editPendaftar() {
        ...
        lifecycleScope.launch {
            val pendaftar = Hafiz_Pendaftaran(nik_pendaftar, nama_pendaftar, umur_pendaftar, jenis_kelamin_pendaftar, penyakit_bawaan_pendaftar, foto_final_dir)
            pendaftar.id = id_pendaftar
            pendaftarDB.getPendaftaranDao().updatePendaftaran(pendaftar)
        }
        val intentPendaftar = Intent(this, Hafiz_PendaftaranActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityHafizEditPendaftaranBinding.inflate(layoutInflater)
        setContentView(binding.root)

        pendaftarDB = Hafiz_VaksinDatabase(this@Hafiz_EditPendaftaranActivity)
