...
import com.pnj.vaksin.data.Hafiz_VaksinDatabase
import com.pnj.vaksin.data.pendaftaran.Hafiz_AddPendaftaranFragment
import com.pnj.vaksin.data.pendaftaran.Hafiz_Pendaftaran
import com.pnj.vaksin.data.pendaftaran.Hafiz_PendaftaranAdapter
import com.pnj.vaksin.databinding.ActivityHafizPendaftaranBinding
import kotlinx.coroutines.launch
import java.io.File

class Hafiz_PendaftaranActivity : AppCompatActivity() {
    private var _binding : ActivityHafizPendaftaranBinding? = null
    ...
    lateinit var vaksinDB: Hafiz_VaksinDatabase

    lateinit var pendaftarList: ArrayList<Hafiz_Pendaftaran>
    ...
    fun loadDataPendaftar() {
        ...
        lifecycleScope.launch{
            pendaftarList = vaksinDB.getPendaftaranDao().getAllPendaftaran() as ArrayList<Hafiz_Pendaftaran>
            Log.e("list pendaftar", pendaftarList.toString())
            pendaftaranRecyclerView.adapter = Hafiz_PendaftaranAdapter(pendaftarList)
        }
    }

    fun deletePendaftar(pendaftar : Hafiz_Pendaftaran) {
        val builder = AlertDialog.Builder(this@Hafiz_PendaftaranActivity)
    ...
    fun searchDataPendaftar(keyword : String) {
        ...
        lifecycleScope.launch {
            pendaftarList = vaksinDB.getPendaftaranDao().searchPendaftaran(keyword) as ArrayList<Hafiz_Pendaftaran>
            Log.e("list pendaftar", pendaftarList.toString())
            pendaftaranRecyclerView.adapter = Hafiz_PendaftaranAdapter(pendaftarList)
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityHafizPendaftaranBinding.inflate(layoutInflater)
        ...
        vaksinDB = Hafiz_VaksinDatabase(this@Hafiz_PendaftaranActivity)

        loadDataPendaftar()

        binding.btnAddPendaftar.setOnClickListener {
            Hafiz_AddPendaftaranFragment().show(supportFragmentManager, "newPendaftarTag")
        }
